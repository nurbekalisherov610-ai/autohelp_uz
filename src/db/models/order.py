...
class Order(Base, TimestampMixin):
    ...
    client_id: Mapped[int] = mapped_column(ForeignKey("users.id", ondelete="RESTRICT"), nullable=False)
    ...
    assigned_dispatcher_telegram_id: Mapped[int | None] = mapped_column(BigInteger, nullable=True)
...
Index("ix_order_status_history_order_id_id", OrderStatusHistory.order_id, OrderStatusHistory.id)
