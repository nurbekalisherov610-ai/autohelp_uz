        ...
        async with async_session() as session:
            ...
            try:
                ...
                for order in violations:
                    await notification.send_sla_alert(order, "sla_alert_assign")
                    logger.warning(
            ...
            try:
                ...
                for order in violations:
                    await notification.send_sla_alert(order, "sla_alert_on_the_way")
                    logger.warning(
            ...
            try:
                ...
                for order in violations:
                    await notification.send_sla_alert(order, "sla_alert_confirm")
                    logger.warning(
